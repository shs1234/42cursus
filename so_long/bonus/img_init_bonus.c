...
/*   Updated: 2023/05/15 18:32:05 by hoseoson         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	img_c(t_vars *vars)
{
	vars->c[0].img = mlx_xpm_file_to_image(vars->mlx,
											"./bonus/imgs/c/collectible1.xpm",
											&vars->c[0].img_width,
											&vars->c[0].img_height);
	vars->c[1].img = mlx_xpm_file_to_image(vars->mlx,
											"./bonus/imgs/c/collectible2.xpm",
											&vars->c[1].img_width,
											&vars->c[1].img_height);
	vars->c[2].img = mlx_xpm_file_to_image(vars->mlx,
											"./bonus/imgs/c/collectible3.xpm",
											&vars->c[2].img_width,
											&vars->c[2].img_height);
}
